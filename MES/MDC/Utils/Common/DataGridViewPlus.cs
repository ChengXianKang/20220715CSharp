...
namespace Utils.Common
{
    public partial class DataGridViewPlus : DataGridView
    {
        public DataGridViewPlus()
        {
            ...
            UpdateStyles();
            this.DataError += new DataGridViewDataErrorEventHandler(DataGridViewPlus_DataError);
        }

        private void DataGridViewPlus_DataError(object sender, DataGridViewDataErrorEventArgs e)
        {

            //throw new NotImplementedException();
        }

        public DataGridViewPlus(IContainer container)
        {
            container.Add(this);
        ...
        [Description("是否显示行号"), Category("自定义属性")]
        public bool ShowLineNumber
        {
            ...
            set
            {
                ...
                {
                    this.RowPostPaint -= this.DataGridView_RowPostPaint;
                }
            }
        }
        /// <summary>
        /// 自定义属性-是否允许点击列标题排序
        /// </summary>
        private bool _sortByColumnHeaderClick = false;
        [Description("是否允许点击列标题排序"), Category("自定义属性")]
        public bool SortByColumnHeaderClick
        {
            get
            {
                return _sortByColumnHeaderClick;
            }
            set
            {
                _sortByColumnHeaderClick = value;
            }
        }
        /// <summary>
        /// 设置或获取合并列的集合
        ...
        private void DataGridViewPlus_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (!_sortByColumnHeaderClick || e.Button != System.Windows.Forms.MouseButtons.Left) return;
            this.Columns[e.ColumnIndex].SortMode = DataGridViewColumnSortMode.Programmatic;
            if (this.Columns[e.ColumnIndex].Tag == null || this.Columns[e.ColumnIndex].Tag.ToString() == "DESC")
            {
                ...
                this.Columns[e.ColumnIndex].Tag = "ASC";
            }
            else
            {
                foreach (DataGridViewColumn col in this.Columns)
                ...
                this.Columns[e.ColumnIndex].Tag = "DESC";
            }
        }
    }
