...
select * from StudentInfo inner join ProfessionInfo 
on StudentInfo.ProfessionID=ProfessionInfo.ProfessionID  
where 1 = 1  and StudentInfo.ProfessionID = 2

insert into StudentInfo(StuID,StuName,StuAge,StuSex,StuHobby,ProfessionID) 
values('099','abc','a','男','体育',1)