...
public class DBHelper
{
    ...
    /// <param name="parameterName">参数名称</param>
    /// <param name="dbType">参数类型</param>
    public void SetInOutParameter(string parameterName, SqlDbType dbType, object parameterValue)
    {
        parameterName = "@" + parameterName.Trim();
        SqlParameter parameter = new SqlParameter(parameterName, dbType);
    ...
    /// <param name="dbType">参数类型</param>
    /// <param name="size">参数长度</param>
    public void SetInOutParameter(string parameterName, SqlDbType dbType, int size, object parameterValue)
    {
        parameterName = "@" + parameterName.Trim();
        SqlParameter parameter = new SqlParameter(parameterName, dbType, size);
        parameter.Value = parameterValue;
